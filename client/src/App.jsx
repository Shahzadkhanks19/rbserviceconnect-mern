...
export default function App(){return <><ScrollToTop/><Suspense fallback={<RouteFallback/>}><Routes>
  ...
  <Route path="candidate" element={<DashboardLayout role="Candidate"/>}><Route index element={<CandidateOverviewPage/>}/><Route path="profile" element={<CandidateProfilePage/>}/><Route path="resume" element={<CandidateResumePage/>}/><Route path="saved-jobs" element={<CandidateSavedJobsPage/>}/><Route path="applications" element={<CandidateApplicationsPage/>}/><Route path="job-alerts" element={<CandidateJobAlertsPage/>}/><Route path="interviews" element={<CandidateInterviewsPage/>}/><Route path="messages" element={<WorkspaceMessagesPage role="candidate"/>}/><Route path="notifications" element={<WorkspaceNotificationsPage role="candidate"/>}/><Route path="settings" element={<CandidateSettingsPage/>}/></Route>
  <Route path="recruiter" element={<DashboardLayout role="Recruiter"/>}><Route index element={<RecruiterOverviewPage/>}/><Route path="company" element={<RecruiterCompanyPage/>}/><Route path="jobs" element={<RecruiterJobsPage/>}/><Route path="applicants" element={<RecruiterApplicantsPage/>}/><Route path="candidate-search" element={<RecruiterCandidateSearchPage/>}/><Route path="talent-pools" element={<RecruiterTalentPoolsPage/>}/><Route path="interviews" element={<RecruiterInterviewsPage/>}/><Route path="messages" element={<WorkspaceMessagesPage role="recruiter"/>}/><Route path="notifications" element={<WorkspaceNotificationsPage role="recruiter"/>}/><Route path="settings" element={<RecruiterSettingsPage/>}/></Route>
