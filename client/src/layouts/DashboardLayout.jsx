import { Activity, BarChart3, Bell, BellRing, Bookmark, BriefcaseBusiness, Building2, CalendarClock, FileText, FolderHeart, LayoutDashboard, LogOut, Mail, Menu, MessageSquare, Search, Settings, ShieldCheck, UserRound, Users, UsersRound, X } from 'lucide-react';
...
const candidateNav = [['','Overview',LayoutDashboard],['profile','Profile',UserRound],['resume','Resume',FileText],['saved-jobs','Saved jobs',Bookmark],['applications','Applications',BriefcaseBusiness],['job-alerts','Job alerts',BellRing],['interviews','Interviews',CalendarClock],['messages','Messages',MessageSquare],['notifications','Notifications',Bell],['settings','Settings',Settings]];
const recruiterNav = [['','Overview',LayoutDashboard],['company','Company profile',Building2],['jobs','Jobs',BriefcaseBusiness],['applicants','Applicants',UsersRound],['candidate-search','Candidate search',Search],['talent-pools','Talent pools',FolderHeart],['interviews','Interviews',CalendarClock],['messages','Messages',MessageSquare],['notifications','Notifications',Bell],['settings','Settings',Settings]];
